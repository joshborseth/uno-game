const PickupCard = () => {
  return (
    ...
    >
      <div className="no-highlight h-40 w-28 cursor-pointer rounded-md border-2 border-black bg-black p-1">
      ...
      <div className="no-highlight h-44 w-32 cursor-pointer rounded-md border-2 border-black bg-black p-1"></div>
      <div className="no-highlight h-44 w-32 cursor-pointer rounded-md border-2 border-black bg-black p-1"></div>
    </button>
  );
};
